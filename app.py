...
sidebar = html.Div(
    [
        ...
        html.Hr(),
        html.P(
            "Учебный проект студентов БСБО-15-21 Савчука Ивана, Булавина Даниила", className="lead", 
        ),
        dbc.Nav(
            [
                dbc.NavLink("Обзор", href="/", active="exact"),
                dbc.NavLink("Глобальные тенденции", href="/page-1", active="exact"),
                dbc.NavLink("Сравнение стран", href="/page-2", active="exact"),
                dbc.NavLink("Результаты университетов", href="/page-3", active="exact"),
